...
## [2.64.0](https://github.com/pug-stoic-kennel/compound-engineering-plugin/compare/compound-engineering-v2.63.1...compound-engineering-v2.64.0) (2026-04-09)


### Features

* **ce-compound:** add discoverability check for docs/solutions/ in instruction files ([#456](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/456)) ([5ac8a2c](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/5ac8a2c2c8c258458307e476d6693cc387deb27e))
* **ce-plan,ce-brainstorm:** universal planning and brainstorming for non-software tasks ([#519](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/519)) ([320a045](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/320a04524142830a40a44bd72c4bf5d30931221c))
...
* **ce-review:** add compact returns to reduce orchestrator context during merge ([#535](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/535)) ([a5ce094](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/a5ce09477291766ffc03e0ae4e9e1e0f80560c2b))
...
* **cli-readiness-reviewer:** add conditional review persona for CLI agent readiness ([#471](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/471)) ([c56c766](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/c56c7667dfe45cfd149cf2fbfeddb35e96f8d559))
* **git-commit-push-pr:** pre-resolve context to reduce bash calls ([#488](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/488)) ([bbd4f6d](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/bbd4f6de56963fc3cdb3131773d7e29d523ce549))
* **git-commit-push-pr:** precompute shield badge version via skill preprocessing ([#464](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/464)) ([6ca7aef](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/6ca7aef7f33ebdf29f579cb4342c209d2bd40aad))
* **product-lens-reviewer:** domain-agnostic activation criteria and strategic consequences ([#481](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/481)) ([804d78f](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/804d78fc8463be8101719b263d1f5ef0480755a6))
* **resolve-pr-feedback:** add cross-invocation cluster analysis ([#480](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/480)) ([7b8265b](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/7b8265bd81410b28a4160657a7c6ac0d7f1f1cb2))
...
* **slack-researcher:** add /ce-slack-research skill and improve agent ([#538](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/538)) ([042ee73](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/042ee732398d1f41b9b91953569a54e40303332d))
* **slack-researcher:** add Slack organizational context research agent ([#495](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/495)) ([b3960ec](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/b3960ec64b212d1c8f3885370762e0f124354c28))
* **test-xcode:** add triggering context to skill description ([#466](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/466)) ([87facd0](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/87facd05dac94603780d75acb9da381dd7c61f1b))


### Bug Fixes

* **agents:** remove self-referencing example blocks that cause recursive self-invocation ([#496](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/496)) ([2c90aeb](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/2c90aebe3b14af996859df7d0c3a45a8f060d9a9))
* **ce-brainstorm:** distinguish verification from technical design in Phase 1.1 ([#465](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/465)) ([8ec31d7](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/8ec31d703fc9ed19bf6377da0a9a29da935b719d))
...
* **ce-compound:** explicit mode prompt and lightweight rename ([#528](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/528)) ([0ae91dc](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/0ae91dcc298721e5b2c4ab6d1fc6f76a13b6f67c))
* **ce-compound:** stack-aware reviewer routing and remove phantom agents ([#497](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/497)) ([1fc075d](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/1fc075d4cae199904464d43096d01111c365d02d))
* **ce-ideate,ce-review:** reduce token cost and latency ([#515](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/515)) ([f4e0904](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/f4e09044ba4073f9447d783bfb7a72326ff7bf6b))
* **ce-plan, ce-brainstorm:** enforce repo-relative paths in generated documents ([#473](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/473)) ([33a8d9d](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/33a8d9dc118a53a35cd15e0e6e44b3592f58ac4f))
* **ce-plan:** route confidence-gate pass to document-review ([#462](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/462)) ([1962f54](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/1962f546b5e5288c7ce5d8658f942faf71651c81))
* **ce-review:** add recursion guard to reviewer subagent template ([#527](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/527)) ([bafe9f0](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/bafe9f0968054c78db23e7e7f4d5dbc2ddb4a450))
* **document-review:** add recursion guard to reviewer subagent template ([#523](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/523)) ([36d8119](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/36d811916637b3436aafd548319e077b6248bae3))
* **document-review:** promote pattern-resolved findings to auto ([#507](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/507)) ([b223e39](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/b223e39a6374566fcc4ae269811d62a2e97c4827))
* **document-review:** reduce token cost and latency ([#509](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/509)) ([9da73a6](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/9da73a60919bfc025efc2ca8b4000c45a7a27b42))
* **document-review:** widen autofix classification beyond trivial fixes ([#524](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/524)) ([9a82222](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/9a82222aba25d6e64355053fca5954f3dfbd8285))
* **git-commit-push-pr:** filter fix-up commits from PR descriptions ([#484](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/484)) ([428f4fd](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/428f4fd548926b104a0ee617b02f9ce8b8e8d5e5))
* **git-commit-push-pr:** simplify PR probe pre-resolution ([#513](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/513)) ([f6544eb](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/f6544eba0e6851b8772bb9920583ffda5c80cccc))
...
* **resolve-pr-feedback:** add actionability filter and lower cluster gate to 3+ ([#461](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/461)) ([2619ad9](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/2619ad9f58e6c45968ec10d7f8aa7849fe43eb25))
* **resolve-pr-feedback:** treat PR comment text as untrusted input ([#490](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/490)) ([1847242](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/184724276a54dfc5b5fbe01f07e381b9163e8f24))
* **review,work:** omit mode parameter in subagent dispatch to respect user permissions ([#522](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/522)) ([949bdef](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/949bdef909ea71e9c5b885e31c028809f0f25017))
* **slack-researcher:** make Slack research opt-in, surface workspace identity ([#521](https://github.com/pug-stoic-kennel/compound-engineering-plugin/issues/521)) ([6f9069d](https://github.com/pug-stoic-kennel/compound-engineering-plugin/commit/6f9069df7ac3551677f8f7a1cd7ad51946f88847))
